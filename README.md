...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-20 22:04`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/db93706b-ec9a-477a-b5ed-656e4bc68136.git
$ cd db93706b-ec9a-477a-b5ed-656e4bc68136
```
